...
public class LostAndFoundActivity extends RobotActivity implements RobotLifecycleCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startMenu(LostAndFoundActivity.this);
            }
        });
    ...
    private void startFoundActivity() {
        Intent intent = new Intent(LostAndFoundActivity.this, FoundItemFormActivity.class);
        startActivity(intent);
    }

    private void startLostActivity() {
        Intent intent = new Intent(LostAndFoundActivity.this, ItemListActivity.class);
        startActivity(intent);
    }

    private void startPicActivity() {
        Intent intent = new Intent(LostAndFoundActivity.this, FoundItemPicture.class);
        startActivity(intent);
    }
