...
public class FoundItemDesc extends RobotActivity implements RobotLifecycleCallbacks {
...
//                etColour.setText(sharedPreferences.getString("colour", ""));
    ...
    private void startNextActivity(Bitmap pictureBitmap) {
        Intent intent = new Intent(FoundItemDesc.this, FoundItemPicture.class);
    ...
    private void startBackActivity() {
        Intent intent = new Intent(FoundItemDesc.this, LostnFoundMain.class);
        startActivity(intent);
    }
